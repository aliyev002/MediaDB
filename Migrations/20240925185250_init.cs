        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Uncategorized")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaMenus", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "MediaRestaurants",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaRestaurants", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaRestaurantId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurants_MediaRestaurants_MediaRestaurantId",
                        column: x => x.MediaRestaurantId,
                        principalTable: "MediaRestaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_MediaUsers_MediaUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaMenuId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dishes_MediaMenus_MediaMenuId",
                        column: x => x.MediaMenuId,
                        principalTable: "MediaMenus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishIngredients", x => new { x.IngredientId, x.MenuId });
                    table.ForeignKey(
                        name: "FK_DishIngredients_Dishes_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_MediaRestaurantId",
                table: "Restaurants",
                column: "MediaRestaurantId",
                unique: true);
